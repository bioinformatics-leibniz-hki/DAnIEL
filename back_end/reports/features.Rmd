...
output:
  html_document:
    ...
    df_print: kable
params:
  reports_dir: /sbidata/server/daniel/latest/src/back_end/reports/
...
- Cumulative sum scaling (css) normalization is used for ordination biplots to ensure non-negative abundance values
