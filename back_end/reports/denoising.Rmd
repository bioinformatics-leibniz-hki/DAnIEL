...
params:
  ...
  project_dir: /sbidata/server/daniel/latest/userdat/test_wo_nonfungal/
...
```{r, eval = denoising_params$denoising_method == "dada2", include = FALSE}
itsx_taxa <- list(
  F = "Fungi",
  Unknown = "Unknown",
  A = "Alveolata",
...
```{rmd, eval = denoising_params$exclude_non_fungal}
...
```{r, eval = denoising_params$exclude_non_fungal, fig.cap="Contamination detected and filtered by ITSx"}
raw_denoised_tbl %>%
