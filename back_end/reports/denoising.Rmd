...
params:
  ...
  project_dir: /home/daniel/prj/7-daniel/userdat/test_human
...
sanity_plt <- if(nrow(samples_tbl) > n_show_max_items) {
  sanity_plt +
...
read_count_plt <- if(nrow(samples_tbl) > n_show_max_items) {
  read_count_plt +
    ggplot2::theme(axis.text.y = element_blank())
}
