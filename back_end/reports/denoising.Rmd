...
params:
  ...
  project_dir: /sbidata/server/daniel/latest/userdat/test_new_example/
...
available <-
  ...
  purrr::possibly(read_csv, FALSE)() %>% nrow() > 0
```
...
"denoising/selected_denoising/pipits/1-seqprep/output.log" %>% readr::read_file() %>% cat()
```
